...
export default function DashboardPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-950 via-violet-950/10 to-slate-950 p-4 lg:p-8">
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
          ...
          <Link href="/dashboard/create">
            <Button className="group bg-gradient-to-r from-violet-600 to-fuchsia-600 hover:from-violet-500 hover:to-fuchsia-500 text-white px-6 py-6 rounded-xl font-semibold shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <Card className="card-glass-strong hover-lift group overflow-hidden relative">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-3">
              <CardTitle className="text-sm font-semibold text-slate-300 group-hover:text-white transition-colors">
                Total Views
              </CardTitle>
          ...
          <Card className="card-glass-strong hover-lift group overflow-hidden relative">
            ...
            <div className="absolute inset-0 bg-gradient-to-br from-rose-600/0 to-pink-600/0 group-hover:from-rose-600/10 group-hover:to-pink-600/10 transition-all duration-500 pointer-events-none" />
          </Card>
          ...
          <Card className="card-glass-strong hover-lift group overflow-hidden relative">
            ...
            <div className="absolute inset-0 bg-gradient-to-br from-amber-600/0 to-yellow-600/0 group-hover:from-amber-600/10 group-hover:to-yellow-600/10 transition-all duration-500 pointer-events-none" />
          </Card>
