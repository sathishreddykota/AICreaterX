...
// Using Perplexity AI for content generation
...
`;
    ...
    const response = await fetch(PERPLEXITY_API_URL, {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: "system",
            content: "You are a professional content writer who creates engaging, well-structured blog posts with proper HTML formatting."
          },
          {
            role: "user",
            content: prompt
    ...
    return {
      success: false,
      error: error.message || error.toString() || "Failed to generate content. Please try again.",
    };
  }
}
    ...
    const response = await fetch(PERPLEXITY_API_URL, {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: "system",
            content: "You are a professional content editor who improves blog posts while maintaining their structure and HTML formatting."
          },
          {
            role: "user",
            content: prompt
